        ...
        private void btnDelete_Click(object sender, EventArgs e)
        {
            ...
            if (result == DialogResult.Yes)
            {
                try
                {
                    ...
                    // if ProductDB.DeleteProduct is false, then the code which is inside ProductCode Textbox doesn't exit.
                    if(!ProductDB.DeleteProduct(product))
                    {
                        ...
                        // if this product isn't null display the existing product. Else Clear the controls.
                        if(product != null)
                        {
                            DisplayProduct();
                        }
                    ...
                    {   // clear controls after deletion is true.
                        ClearControls();
                    }
                }
                catch (Exception ex)
